...
# Path to the directory containing the SANA model files
base_model_path = "/Volumes/KINGSTON/sana-1.6b-1024px"

# Path to the transformer checkpoint
transformer_path = os.path.join(base_model_path, "transformer", "diffusion_pytorch_model.safetensors")
...
converted_state_dict = convert_state_dict(transformer_state_dict)

# Output path for the combined checkpoint
output_checkpoint_path = "/Volumes/KINGSTON/ComfyUI/models/checkpoints/sana-1.6b-1024px_checkpoint.ckpt"

# Save the converted checkpoint
save_file(converted_state_dict, output_checkpoint_path)
print(f"Combined checkpoint saved to {output_checkpoint_path}")
